...
export const rowDateClass =
  "w-22 flex-none font-mono text-xs tracking-[0.12em] text-cron-subtle uppercase tabular-nums transition-colors duration-300 group-hover:text-cron-accent group-focus-visible:text-cron-accent"
...
export const rowArrowClass =
  "size-4.5 flex-none -translate-x-2 text-cron-accent opacity-0 [transition:opacity_.3s,translate_.35s_cubic-bezier(.2,.8,.2,1)] group-hover:translate-x-0 group-hover:opacity-100 group-focus-visible:translate-x-0 group-focus-visible:opacity-100"
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start gap-[clamp(1.5rem,4vw,4rem)] pt-[clamp(0.5rem,1.5vw,1.25rem)]">
        <div
          aria-hidden="true"
          className="font-heading text-[clamp(4.5rem,10vw,8.5rem)] leading-[0.82] font-semibold tracking-[-0.05em] text-cron-accent tabular-nums"
        >
          {numeral}
        </div>
